 ...
 */
window.bridge.on('saveMenuItemSelect', (event: any) => {
  onSave();
});
 ...
 */
window.bridge.on('closeProjectMenuItemSelect', async (event: any) => {
  onCloseProject();
});
 ...
 */
window.bridge.on('closeTabMenuItemSelect', (event: any) => {
